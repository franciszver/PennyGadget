...
def test_qa_endpoint(user_id, email):
    ...
    try:
        ...
        payload = {"student_id": user_id, "query": "What is photosynthesis?"}
...
def test_practice_endpoint(user_id, email):
    ...
    try:
        ...
        params = {"student_id": user_id, "subject": "Math", "num_items": 3}
...
def main():
    ...
    for email, scenario_name in scenarios.items():
        ...
        results[email] = {"progress": progress_ok, "nudges": nudges_ok}
